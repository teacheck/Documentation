...
\irudia{template/figs/analisis1.png}{0.9}{Tabla de activos}
...
\irudia{template/figs/analisis2-1.jpg}{0.8}{Tabla - Resumen Amenazas 1}

\irudia{template/figs/analisis2-2.jpg}{0.8}{Tabla - Resumen Amenazas 2}
...
\irudia{template/figs/analisis3.jpg}{0.8}{Tabla para el cálculo de la probabilidad}
\paragraph{}
Tabla para el cálculo del impacto
\irudia{template/figs/analisis4.jpg}{0.8}{Tabla para el cálculo del impacto}
\paragraph{}
...
\paragraph{}
Matriz de riesgo
\irudia{template/figs/analisis5.jpg}{0.8}{Matriz de riesgo}
\paragraph{}
\textbf{Aplicación web}
